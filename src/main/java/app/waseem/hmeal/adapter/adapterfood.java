...
import app.waseem.hmeal.lunch;

/**
 * Created by hp pro 4540s on 4/21/2018.
 */
...
public class adapterfood extends RecyclerView.Adapter<adapterfood.ViewHolder>  {
    ...
    public adapterfood (List<ItemlistRest> list_Item, Context context){
        List_Item = list_Item;
    ...
    @Override
    public void onBindViewHolder(adapterfood.ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FragmentUtil.replaceFragmentWithBackStack(context, new lunch(), R.id.frameparpa, null);
